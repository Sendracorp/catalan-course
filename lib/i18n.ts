...
const fr: Dict = {
  ...
  auth: {
    titles: { login: 'Content de vous revoir', signup: 'Créez votre compte', forgot: 'Réinitialisez votre mot de passe', reset: 'Choisissez un nouveau mot de passe' },
    subtitles: {
    ...
    actions: { login: 'Se connecter', signup: 'Créer un compte', forgot: 'Envoyer le lien', reset: 'Mettre à jour le mot de passe' },
...
const ru: Dict = {
  ...
  auth: {
    ...
    google: 'Продолжить через Google', orEmail: 'или по эл. почте',
  ...
  pricing: {
    ...
    faq: [
      ...
      { q: 'Можно вернуть деньги?', a: 'Курсы цифровые с мгновенным доступом навсегда, поэтому продажи окончательны — сначала воспользуйтесь бесплатным доступом. Если что-то не работает или списано дважды, напишите нам.' },
    ],
  },
};
...
const de: Dict = {
  ...
  auth: {
    ...
    subtitles: {
      ...
      signup: 'Speichere deinen Fortschritt und synchronisiere ihn auf allen Geräten.',
    ...
    noAccount: 'Noch kein Konto? Erstelle eins', forgotLink: 'Passwort vergessen?',
